    ...
    return (
        <div style={{backgroundColor:"var(--brown)"}}>
            <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="8.97in" height="4.38in" viewBox="0 0 646.01 315.57">
                ...
                <motion.path variants={variants} initial="initial" animate="pathThree" d="M723.21,252s-22.72,89.36-27.06,137.36" transform="translate(-80.11 -136.84)" stroke="#fff" strokeWidth ="6px"/>
